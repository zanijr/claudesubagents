...
hooks:
  PostToolUseFailure:
    - matcher: "Bash|Agent"
      hooks:
        - type: command
          command: "bash ${CLAUDE_PLUGIN_ROOT}/skills/orchestrator/scripts/capture-failure.sh"
  Stop:
    - hooks:
        - type: command
          command: "bash ${CLAUDE_PLUGIN_ROOT}/skills/orchestrator/scripts/save-lessons.sh"
---
